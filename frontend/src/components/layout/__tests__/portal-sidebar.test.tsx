...
describe('PortalSidebar', () => {
  ...
  it('renders all navigation items', () => {
    ...
    expect(screen.getAllByRole('link', { name: /venue funding/i }).length).toBeGreaterThanOrEqual(1)
  ...
  it('navigation items have correct href attributes', () => {
    ...
    const venueFundingLinks = screen.getAllByRole('link', { name: /venue funding/i })
    ...
    expect(venueFundingLinks[0]).toHaveAttribute('href', '/portal/venues')
