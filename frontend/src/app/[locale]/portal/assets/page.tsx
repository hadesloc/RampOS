...
export default function AssetsPage() {
  ...
  const formatCrypto = (value: number, symbol: string) => {
    return `${format.number(value, { maximumFractionDigits: 8 })} ${symbol}`;
  };
    ...
    <PageContainer>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
        ...
        <Card className="col-span-4 lg:col-span-4">
          <CardHeader>
            <CardTitle>{t('total_value')}</CardTitle>
            <CardDescription>
              {t('description')}
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
                 ...
                 <div className="p-4 rounded-xl bg-muted/30 border">
                    <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1">{t('count')}</p>
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-semibold tracking-tight">{tNav('assets')}</h2>
        {assets.length > 0 ? (
