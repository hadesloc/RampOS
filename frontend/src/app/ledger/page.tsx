...
function getAccountTypeColor(type: string): string {
  if (type.startsWith("USER_")) return "bg-blue-100 text-blue-800";
  if (type.startsWith("PLATFORM_")) return "bg-purple-100 text-purple-800";
  if (type.startsWith("TENANT_")) return "bg-green-100 text-green-800";
