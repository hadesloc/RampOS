...
import { share as s, map as l, filter as v, merge as d, mergeMap as p, empty as c, fromArray as u, makeSubject as f, onPush as y } from "wonka";
    ...
    while (this.stack.length > 0) {
      ...
      while (e.index < e.selectionSet.length) {
        ...
        if (!shouldInclude(r, this.ctx.variables)) {} else if (r.kind !== n.FIELD) {
          ...
          if (t) {
            var a = !t.typeCondition || (this.ctx.store.schema ? isInterfaceOfType(this.ctx.store.schema, t, this.typename) : this.ctx.store.possibleTypeMap ? isSuperType(this.ctx.store.possibleTypeMap, t.typeCondition.name.value, this.typename) : "read" === D && isFragmentMatching(t.typeCondition.name.value, this.typename) || isFragmentHeuristicallyMatching(t, this.typename, this.entityKey, this.ctx.variables, this.ctx.store.logger));
...
var readSelection = (e, r, t, a, i) => {
  ...
  var f = e.partial;
  var y = makeData(a);
  while (void 0 !== (u = v.next())) {
    var h = getName(u);
    var m = getFieldArguments(u, e.variables);
    var g = getFieldAlias(u);
    var _ = getDirectives(u);
    ...
    if ("__typename" === h) {
      b = l;
    } else if (void 0 !== w && void 0 === u.selectionSet) {
      b = w;
    } else if ("read" === D && N) {
      var x = y;
      if (void 0 === u.selectionSet && void 0 !== O) {
        x = {
          ...y,
          [g]: O,
          [h]: O
      ...
      b = N(x, m || {}, n, e);
      if (u.selectionSet) {
        b = resolveResolverResult(e, l, h, E, getSelectionSet(u), void 0 !== y[g] ? y[g] : a[g], b, ownsData(a));
      }
      ...
      b = resolveResolverResult(e, l, h, E, getSelectionSet(u), void 0 !== y[g] ? y[g] : a[g], w, ownsData(a));
    } else {
      var I = readLink(s, k);
      if (void 0 !== I) {
        b = resolveLink(e, I, l, h, getSelectionSet(u), void 0 !== y[g] ? y[g] : a[g], ownsData(a));
      } else if ("object" == typeof O && null !== O) {
        b = O;
      }
    }
    if (!S && void 0 === b && (_.optional || A && !_.required || getFieldError(e) || !_.required && n.schema && isFieldNullable(n.schema, l, h, e.store.logger))) {
      e.partial = !0;
      b = null;
...
var resolveResolverResult = (e, r, t, a, i, n, o, s) => {
  if (Array.isArray(o)) {
    ...
    for (var u = 0, f = o.length; u < f; u++) {
      ...
      var y = resolveResolverResult(e, r, t, joinKeys(a, `${u}`), i, null != n ? n[u] : void 0, o[u], s);
      e.__internal.path.pop();
      if (void 0 === y && !v) {
        e.partial = d;
        return;
...
var resolveLink = (e, r, t, a, i, n, o) => {
  if (Array.isArray(r)) {
    ...
    var v = makeData(n, !0);
    var d = e.partial;
    var p = V || !Array.isArray(n) || r.length !== n.length;
...
var writeSelection = (e, r, t, a) => {
  ...
  while (v = l.next()) {
    var d = getName(v);
    var p = getFieldArguments(v, e.variables);
    var c = keyOfField(d, p);
    var u = getFieldAlias(v);
    var f = a[e.optimistic ? d : u];
    if ("__typename" === d || void 0 === f && (S || e.optimistic && "query" === i)) {
      continue;
    }
    if ("production" !== process.env.NODE_ENV) {
...
class Store {
  constructor(e) {
    ...
    if (!this.schema && e.possibleTypes) {
      this.possibleTypeMap = new Map;
      for (var n of Object.entries(e.possibleTypes)) {
        var [o, s] = n;
        this.possibleTypeMap.set(o, new Set(s));
      }
    }
...
var cacheExchange = e => ({forward: t, client: i, dispatchDebug: n}) => {
  ...
  return e => {
    ...
    var m = l((e => {
      ...
      return addMetadata(e.operation, {
        cacheOutcome: "miss"
      });
    ...
    var N = l((e => {
      ...
      var s, l;
      var v = {
        operation: addMetadata(e.operation, {
...
var offlineExchange = e => r => {
  ...
  if (n && n.onOnline && n.readMetadata && n.writeMetadata) {
    var {forward: l, client: p, dispatchDebug: c} = r;
    var {source: u, next: h} = f();
    var m = [];
    var g = !1;
    var _ = !1;
    var updateMetadata = () => {
          ...
          return {
            async then(r) {
              ...
              for (var i = 0; a && i < a.length; i++) {
                m.push(p.createRequestOperation("mutation", t(a[i].query, a[i].variables), a[i].extensions));
              }
              r(await e);
